...
public class UsuarioTest {
    ...
    public void testUsuarioConstructorAndFields() {
        ...
        class UsuarioConcreto extends Usuario {
            public UsuarioConcreto(String id, String nome, String email, String login, String password, java.time.ZonedDateTime dataUltimaAlteracao, UsuarioRole role, Endereco endereco) {
